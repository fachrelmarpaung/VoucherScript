...
$outletClass = new outletClass();
// print_r($_SERVER);
$perPage = 5;

// Retrieve paginated outlets
$outlets = $outletClass->getOutlet();
if(empty($_SESSION['user'])){
    header('Location: ../administrator');
}
if (isset($_POST['send'])) {
    $phone = $_POST['phonenumber'] ?? '';
    $templateId = $_POST['idoutlet'] ?? '';
    ...
    $senderInstance = new sender($phone, $templateId);

    // Call the sendTextMessageFromUrl method
    $senderInstance->sendTextMessageFromUrl();
                    ...
                    <div class="col-lg-4 d-flex align-items-stretch">
                      <div class="d-flex flex-column align-items-start w-100">
                        <div class="text-start">
                          <h5 class="card-title fw-semibold">Join Komunitas</h5>
                          <span><?= date("M"); ?> 1, <?= date("Y"); ?> - <?= date("M"); ?> 31, <?= date("Y"); ?></span>
                        </div>
                        <div class="mt-lg-auto mt-4 mb-4">
                          <span class="text-dark">Total Users
                          </span>
                          <h2 class="mt-2 fw-bold"><?= $homeInstance->getAllData(); ?></h2>
                          <span>Persentase bergabung komunitas</span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row gx-0">
                    <div class="col-md-4 border-end">
                      <div class="p-4 py-3 py-md-4">
                        ...
                        <h3 class=" mt-2 mb-0"><?= $homeInstance->getAllData(); ?></h3>
                      </div>
                    </div>
                    <div class="col-md-4 border-end">
                      <div class="p-4 py-3 py-md-4">
                        ...
                        <h3 class=" mt-2 mb-0"><?= $homeInstance->getDataVerified(); ?></h3>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="p-4 py-3 py-md-4">
                        ...
                        <h3 class=" mt-2 mb-0"><?= $homeInstance->getDatanonVerified(); ?></h3>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-md-flex align-items-center mb-9">
                    <div>
                      <h5 class="card-title fw-semibold">Outlet Persentase</h5>
                      <p class="card-subtitle">Total Users outlet</p>
                    </div>
                  </div>
                  <!-- Tab panes -->
                          ...
                          <tbody>
                            <tr>
                              <td class="ps-0">
                                <div class="d-flex align-items-center gap-3">
                                  <div>
                                    <h6 class="mb-0 fw-semibold">Outlet</h6>
                                  </div>
                                </div>
                              </td>
                              <td class="ps-0">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                  <div>
                                    <h6 class="mb-0 fw-semibold">
                                      <a href="Viewnumber?outlet=<?= $outlet['idoutlet']; ?>&p=1"><?= $outlet['outlatename']; ?>
                                    </a></h6>
                                  </div>
                                </div>
                              </td>
                              <td class="ps-0">
                                <h6 class="mb-0"><?= $outlet['idoutlet']; ?></h6>
                              </td>
                              <td class="ps-0">
                                <h6 class="mb-0"><?= $outletClass->getDatanonVerified($outlet['idoutlet']); ?></h6>
                              </td>
                              <td class="text-end ps-0">
                                <h6 class="mb-0">
                                    <?php
                                    $val1 = $homeInstance->getAllData();
                                    $val2 = $outletClass->getDatanonVerified($outlet['idoutlet']);
                                    if($val2 != 0)
                                    {
                                        $res = ( $val2 / $val1) * 100;
