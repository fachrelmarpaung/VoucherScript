...
$LoadNumber = $outletHandler->ListValid();
...
if (empty(@$_GET['p'])) {
    ...
    $LoadNumber = $outletHandler->cariNumberValid($_GET['search']);
}if (isset($_POST['find'])) {
    if ($outletHandler->carikanValid($_POST['search']) > 0) {
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-md-flex align-items-center mb-9">
                    <div>
                      <h5 class="card-title fw-semibold">Total User <span class="badge text-bg-success rounded"><?= $outletHandler->TotalValid(); ?> </span></h5>
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td class="ps-0">
                                ...
                                if(isset($_GET['short'])){
                                  ?>
                                    <a href="?p=<?=$_GET['p'];?>"><i class="ti ti-chevron-up text-muted ms-1 fs-4"></i></a>
                                  <?php
                                }else{
                                  ?>
                                  <a href="?p=<?=$_GET['p'];?>&short=asc"><i class="ti ti-chevron-down text-muted ms-1 fs-4"></i></a>
                                <?php
                                }
                                 ?>
                                </h6>
                            ...
                            <tr>
                              ...
                              <td class="ps-0">
                                <h6 class="mb-0"><a href="Viewnumber?outlet=<?= $Number['idoutlet']; ?>&p=1"><?= $Number['idoutlet']; ?></a></h6>
                              </td>
                              <td class="ps-0">
