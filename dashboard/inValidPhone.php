...
$LoadNumber = $outletHandler->ListInvalid();
...
if (empty(@$_GET['p'])) {
    ...
    $LoadNumber = $outletHandler->cariNumberInvalid($_GET['search']);
}if (isset($_POST['find'])) {
    if ($outletHandler->carikanInvalid($_POST['search']) > 0) {
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-md-flex align-items-center mb-9">
                    <div>
                      <h5 class="card-title fw-semibold">Total User unVerified <span class="badge text-bg-success rounded"><?= $outletHandler->TotalInValid(); ?></span></h5>
                      <p class="card-subtitle">Total Users unVerified</p>
                    </div>
                    <div class="ms-auto">
                        <form method="POST">
                            <table>
