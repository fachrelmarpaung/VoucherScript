              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-md-flex align-items-center mb-9">
                    <div>
                      <h5 class="card-title fw-semibold">Total User Verified <span class="badge text-bg-success rounded"><?= $outletHandler->TotalValid(); ?></span></h5>
                      <p class="card-subtitle">Total Users Verified</p>
                    </div>
                    <div class="ms-auto">
                        <form method="POST">
                            <table>
