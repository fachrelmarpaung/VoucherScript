...
$outletHandler = new Users();
$LoadNumber = $outletHandler->ListAdminId();
...
if (empty(@$_GET['p'])) {
    ...
    $LoadNumber = $outletHandler->cariAdmin($_GET['search']);
}if (isset($_POST['find'])) {
    if ($outletHandler->carikan($_POST['search']) > 0) {
...
if(isset($_POST['delete'])){
  ...
  $redirect = "?success";
  $result = $outletHandler->deleteAdmin($phonenum, $redirect); 
}
?>
<!DOCTYPE html>
<html lang="en">
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-md-flex align-items-center mb-9">
                    <div>
                      <h5 class="card-title fw-semibold">Total Admin <span class="badge text-bg-success rounded"><?= $outletHandler->TotalAdmins(); ?></span></h5>
                      <p class="card-subtitle">Total Pengurus</p>
                    </div>
                  </div>
                  <!-- Tab panes -->
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="ps-0">
                                <div class="d-flex align-items-center gap-3">
                                  <div>
                                    <h6 class="mb-0 fw-semibold"><?= $Number['username']; ?></h6>
                                  </div>
                                </div>
                              </td>
                              <td class="ps-0">
                                <h6 class="mb-0"><?= $Number['Fullname']; ?></h6>
                              </td>
                              <td class="ps-0">
                                <h6 class="mb-0"><?= $Number['created']; ?></h6>
                              </td>
                            </tr>
                            <?php
                                    }
                            ...
                            <tr>
                              <td class="ps-0">
                                <div class="d-flex align-items-center gap-3">
                                  <div class="flex-shrink-0">
                                    <img src="../dist/images/products/product-2.jpg" class="rounded" alt="p2" width="80" />
                                  </div>
                                  <div>
                              ...
                              <td class="text-end ps-0">
                                <span class="badge bg-light-success text-success rounded-pill">
                                  <span class="round-8 bg-success rounded-circle d-inline-block me-1"></span>delivered </span>
                              </td>
                            </tr>
                            <tr>
                              <td class="ps-0">
                                <div class="d-flex align-items-center gap-3">
                                  <div class="flex-shrink-0">
                                    <img src="../dist/images/products/product-1.jpg" class="rounded" alt="p1" width="80" />
                                  </div>
                                  <div>
                              ...
                              <td class="text-end ps-0">
                                <span class="badge bg-light-warning text-warning rounded-pill">
                                  <span class="round-8 bg-warning rounded-circle d-inline-block me-1"></span>progress </span>
                              </td>
                            </tr>
                            <tr>
                              <td class="ps-0">
                                <div class="d-flex align-items-center gap-3">
                                  <div class="flex-shrink-0">
                                    <img src="../dist/images/products/product-3.jpg" class="rounded" alt="p3" width="80" />
                                  </div>
                                  <div>
                              ...
                              <td class="text-end ps-0">
                                <span class="badge bg-light-danger text-danger rounded-pill">
                                  <span class="round-8 bg-danger rounded-circle d-inline-block me-1"></span>cancel </span>
                              </td>
                            </tr>
                            <tr>
                              <td class="ps-0">
                                <div class="d-flex align-items-center gap-3">
                                  <div class="flex-shrink-0">
                                    <img src="../dist/images/products/product-4.jpg" class="rounded" alt="p4" width="80" />
                                  </div>
                                  <div>
                                    <h6 class="mb-0 fw-semibold">Irpun Wicaksono</h6>
                                    <span class="fs-2">irpun@gmail.com</span>
                        ...
                        <table class="table table-hover align-middle mb-0 text-nowrap">
                          <tbody>
                            <tr>
                              ...
                              <td class="text-end ps-0">
                                <a href="javascript:void(0)" class="badge bg-light-success text-success rounded-pill">
                                  <span class="round-8 bg-success rounded-circle d-inline-block me-1"></span>delivered </a>
                              </td>
                            </tr>
                            <tr>
                              <td class="ps-0">
