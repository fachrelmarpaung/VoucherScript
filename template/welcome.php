...
<body>
    ...
    <div class="main">
        ...
        <div class="title">
            <span style="font-weight: 700;">🎉Undangan Special!🎉</span>
        </div>
        <div class="action" style="text-align:left; max-width:600px;">
            <?= $load->loadData(); ?>
            <hr style="margin-top:10px; margin-bottom:5px;">
            <span style="font-weight:600; text-align:center;">Join dan Dapatkan Voucher Gratis Pizza</span><br>
            Eksklusif untuk member baru Komunitas Whatsapp Pizzahut Delivery<br>
            Voucher akan dikirim dalam 1x24 jam
            <a href="Voucher" class="success" style="text-align:center;">Join Komunitas <i class="bi bi-whatsapp"></i></a>
        </div>
    </div>
</body>
</html>
