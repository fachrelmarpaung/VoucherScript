          ...
          <div class="row justify-content-center w-100">
            <div class="col-lg-4">
              <div class="text-center">
                <img src="https://www.pizzahut.co.id/img/logo-phd2.1e64ffda.png" alt="" width="350px" class="img-fluid">
                <h1 class="fw-semibold mb-7 fs-9">Opps!!!</h1>
                <h4 class="fw-semibold mb-7">This page you are looking for could not be found.</h4>
                <a class="btn btn-danger" href="https://pizzahut.co.id/" role="button">Go Back to Home</a>
              </div>
            </div>
          </div>
        </div>
